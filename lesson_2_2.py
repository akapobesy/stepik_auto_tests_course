...
try: 
    ...
    buttom = browser.find_element(By.ID, "answer").send_keys(answer)
    buttom1 = browser.find_element(By.ID, "robotCheckbox").click()
    buttom2 = browser.find_element(By.ID, "robotsRule").click()
    buttom3 = browser.find_element(By.CSS_SELECTOR, ".btn.btn-default").click()
